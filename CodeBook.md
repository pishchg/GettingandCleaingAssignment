##Variables present in the tidy_averages.txt
...
#Here are these variables. Note that some of them are present in duplicate or triplicate. The duplicate variable names are followed by '1' and triplicate names are followed by '1 1 in the table:
